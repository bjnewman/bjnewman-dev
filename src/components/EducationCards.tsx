...
const ComputerIcon = ({ isHovered }: { isHovered: boolean }) => (
  ...
  >
    {/* Monitor */}
    <rect x="8" y="8" width="48" height="36" rx="3" fill="none" stroke="currentColor" strokeWidth="2" />
    {/* Screen */}
    ...
    {/* Cursor blink */}
    <rect x="32" y="34" width="2" height="4" fill="var(--primary)" className="education-icon__cursor" />
  </svg>
);
...
const GavelIcon = ({ isHovered }: { isHovered: boolean }) => (
  ...
  >
    ...
    {/* Sound block */}
    <ellipse cx="48" cy="48" rx="10" ry="4" fill="var(--bg-tertiary)" stroke="currentColor" strokeWidth="2" />
    <ellipse cx="48" cy="44" rx="10" ry="4" fill="var(--primary-light)" stroke="currentColor" strokeWidth="2" />
    {/* Impact lines */}
    <g className="education-icon__impact">
      <line x1="40" y1="36" x2="36" y2="32" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" />
      <line x1="48" y1="34" x2="48" y2="28" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" />
      <line x1="56" y1="36" x2="60" y2="32" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" />
    </g>
  </svg>
);
...
const ThinkerIcon = ({ isHovered }: { isHovered: boolean }) => (
  ...
  >
    ...
    <path d="M24 24 Q20 28 22 32" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    {/* Body */}
    <path d="M28 24 L28 36 Q28 44 36 48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    {/* Arm to chin */}
    <path d="M28 30 L22 28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    {/* Legs */}
    <path d="M28 36 L20 52" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <path d="M28 40 L36 52" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    {/* Base/pedestal */}
    <rect x="12" y="52" width="32" height="4" rx="1" fill="var(--bg-tertiary)" stroke="currentColor" strokeWidth="1" />
    {/* Thought bubbles */}
    ...
    <g className="education-icon__question">
      <text x="50" y="14" fontSize="12" fill="var(--primary)" fontWeight="bold">?</text>
    </g>
  </svg>
);
